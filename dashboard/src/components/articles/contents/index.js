    ...
    return (
        <ListWrapper>
            <ListSearchBoxWrapper>
                <SearchBox name='keyword' onChange={onChange} value={keyword} onClick={handleSearch} />
            </ListSearchBoxWrapper>

            <ListTableWrapper>
                <ListTable items={data.rooms} />
                <PageNationComponent currentPage={page} lastPage={data.lastPage} link={URL} search={search} />
            </ListTableWrapper>
        </ListWrapper>
    )
}
